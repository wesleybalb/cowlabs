export default function NavUserImg({ userType }) {
  const picProfile = {
    width: "50px",
    height: "50px",
  };
    ...
    if (user.tipo == "Professor") {
      ...
      switch (user.curso) {
        ...
        case "Publicidade e Propaganda":
          ProfileImg =
            "/src/assets/img/profile_img/Publicidade_e_Propaganda.png";
          break;
        case "Serviço Social":
        ...
        default:
          text =
            "I'm a Cow in a Lab Cowlaborating with my fellow cows to create the best milk products in the world!";
      }
    }
  }
  ...
  return (
    <>
      <img src={ProfileImg} className={userType} style={picProfile}/>
    </>
  );
}
